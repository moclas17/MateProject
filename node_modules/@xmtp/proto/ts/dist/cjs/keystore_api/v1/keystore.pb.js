...
function createBaseCreateInviteFromTopicRequest() {
    return { recipient: undefined, contentTopic: "", createdNs: long_1.default.UZERO };
}
exports.CreateInviteFromTopicRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.recipient !== undefined) {
            public_key_pb_1.SignedPublicKeyBundle.encode(message.recipient, writer.uint32(10).fork()).ldelim();
        }
        if (message.contentTopic !== "") {
...
function createBaseCreateInvitesRequest() {
    return { context: undefined, recipients: [], createdNs: long_1.default.UZERO };
}
exports.CreateInvitesRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.context !== undefined) {
            invitation_pb_1.InvitationV1_Context.encode(message.context, writer.uint32(10).fork()).ldelim();
        }
        for (const v of message.recipients) {
            public_key_pb_1.SignedPublicKeyBundle.encode(v, writer.uint32(18).fork()).ldelim();
        }
        if (!message.createdNs.isZero()) {
            writer.uint32(24).uint64(message.createdNs);
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.recipients.push(public_key_pb_1.SignedPublicKeyBundle.decode(reader, reader.uint32()));
                    break;
                case 3:
                    message.createdNs = reader.uint64();
                    break;
    ...
    fromJSON(object) {
        return {
            ...
            recipients: Array.isArray(object === null || object === void 0 ? void 0 : object.recipients)
                ? object.recipients.map((e) => public_key_pb_1.SignedPublicKeyBundle.fromJSON(e))
                : [],
            createdNs: isSet(object.createdNs)
                ? long_1.default.fromValue(object.createdNs)
                : long_1.default.UZERO,
    ...
    toJSON(message) {
        ...
        if (message.recipients) {
            obj.recipients = message.recipients.map((e) => e ? public_key_pb_1.SignedPublicKeyBundle.toJSON(e) : undefined);
        }
        else {
            obj.recipients = [];
        }
    ...
    fromPartial(object) {
        ...
        message.context =
            object.context !== undefined && object.context !== null
                ...
                : undefined;
        message.recipients =
            ((_a = object.recipients) === null || _a === void 0 ? void 0 : _a.map((e) => public_key_pb_1.SignedPublicKeyBundle.fromPartial(e))) || [];
        message.createdNs =
            object.createdNs !== undefined && object.createdNs !== null
                ? long_1.default.fromValue(object.createdNs)
                : long_1.default.UZERO;
...
exports.CreateInvitesResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        for (const v of message.responses) {
            exports.CreateInviteResponse.encode(v, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.responses.push(exports.CreateInviteResponse.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            responses: Array.isArray(object === null || object === void 0 ? void 0 : object.responses)
                ? object.responses.map((e) => exports.CreateInviteResponse.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        const obj = {};
        if (message.responses) {
            obj.responses = message.responses.map((e) => e ? exports.CreateInviteResponse.toJSON(e) : undefined);
        }
        else {
            obj.responses = [];
        }
    ...
    fromPartial(object) {
        ...
        const message = createBaseCreateInvitesResponse();
        message.responses =
            ((_a = object.responses) === null || _a === void 0 ? void 0 : _a.map((e) => exports.CreateInviteResponse.fromPartial(e))) || [];
        return message;
    },
};
