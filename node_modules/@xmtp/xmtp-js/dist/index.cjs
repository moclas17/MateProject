...
var SignedPrivateKey = class {
  ...
  async sign(digest) {
    const [signature5, recovery] = await secp2__namespace.sign(
      digest,
...
var ConversationV2 = class {
  ...
  async processEnvelope(env) {
    ...
    const msg = proto.message.Message.decode(messageBytes);
    if (!msg.v2) {
...
var Conversations = class {
  constructor(client) {
    ...
    this.v2Mutex = new asyncMutex.Mutex();
  }
  /**
...
var { b64Decode: b64Decode2 } = proto.fetcher;
...
var InviteStore = class {
  ...
  static async create(persistence) {
    if (persistence) {
      ...
      if (rawData) {
        try {
          const inviteMap = typeSafeTopicMap(proto.keystore.TopicMap.decode(rawData));
...
var { b64Decode: b64Decode3 } = proto.fetcher;
...
exports.ContentTypeTypingNotification = ContentTypeTypingNotification;
